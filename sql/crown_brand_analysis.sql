SELECT
		 ...
		 COUNT(pi."Parent ID") AS "Crown Count",
...
WHERE	 TRIM(pl."Brand")  IN ( 'Ivoclar'  , 'Zahn'  , 'AmannGirrbach'  , 'Straumann'  , 'Porcelain'  )
 AND	TRIM(pl."Product Category")  IN ( 'Crown'  , 'Holywood Smile'  )
