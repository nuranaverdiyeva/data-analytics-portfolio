...
WHERE	 d."Closing Date"  >= '2026-08-01'
 AND	d."Closing Date"  < '2026-09-01'
...
SELECT
		 "Main Markets",
		 SUM(CASE
				 WHEN "Brand"  = 'Zahn' THEN "Quantity"
				 ELSE 0
			 END) AS "Zahn",
		 SUM(CASE
				 WHEN "Brand"  = 'Straumann' THEN "Quantity"
				 ELSE 0
			 END) AS "Straumann",
		 SUM(CASE
				 WHEN "Brand"  = 'Porcelain' THEN "Quantity"
				 ELSE 0
			 END) AS "Porcelain",
		 SUM(CASE
				 WHEN "Brand"  = 'Ivoclar' THEN "Quantity"
				 ELSE 0
			 END) AS "Ivoclar",
		 SUM(CASE
				 WHEN "Brand"  = 'AmannGirrbach' THEN "Quantity"
				 ELSE 0
			 END) AS "AmannGirrbach",
