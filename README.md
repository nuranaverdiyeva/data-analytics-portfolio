...
| [Month-over-Month Deal Size and Volume](sql/avg_deal_size_by_market_visit_mom.sql) | July vs. June average deal size and volume, with a per-market rollup | Conditional aggregation, `NULLIF`, `UNION ALL` |
